    ...
    return {
        ...
        execute: function() {
            LeaderboardComponent = (function () {
                function LeaderboardComponent(_router, _heroService) {
                ...
                LeaderboardComponent.prototype.onSelect = function (hero) { this.selectedHero = hero; };
                LeaderboardComponent.prototype.gotoDetail = function () {
